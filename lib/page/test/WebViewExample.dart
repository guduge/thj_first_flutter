...
//    controller.loadUrl('data:text/html;$kNavigationExamplePage');
    var a = Uri.dataFromString(kNavigationExamplePage);
  controller.loadUrl(a.toString(),);
  }
