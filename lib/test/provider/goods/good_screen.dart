...
class FirstScreenState extends State<FirstScreen>  with AutomaticKeepAliveClientMixin {
  ...
  void initState() {
    super.initState();
    print("FirstScreenState --- initState");
  }
}
...
class _SecondScreenProviderState extends State<SecondScreenProvider> with AutomaticKeepAliveClientMixin {
