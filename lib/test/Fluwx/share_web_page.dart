...
class ShareWebPagePageState extends State<ShareWebPagePage> {
  ...
  String _title = "Fluwx";
  String _thumnail = "assets://images/youluIcon.png";
      ...
      body: Padding(
        ...
        child: new Column(
          children: <Widget>[
            ...
            new TextField(
              controller:
                  TextEditingController(text: "assets://images/youluIcon.png"),
              onChanged: (str) {
                _thumnail = str;
              },
              decoration: InputDecoration(labelText: "thumbnail"),
  ...
  void _share() {
    var model = fluwx.WeChatShareWebPageModel(
        ...
        thumbnail: _thumnail,
        scene: scene,
        description:"描述哈哈哈哈哈哈",
        transaction: "哈哈哈哈哈哈");
    fluwx.share(model).then((res)=>{
    debugPrint('wevvvvvxxxxxxx'),
        print(res)
    });
  }
