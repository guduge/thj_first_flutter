...
static Byte saltBuff1[] = {104,81,98,111,75,56,66,50,118,89,51,114,76,112,50,73};
static Byte ivBuff1[] = {104,81,98,111,75,56,66,50,118,89,51,114,76,112,50,73};
...
const NSUInteger kAlgorithmKeySize1 = kCCKeySizeAES256;
// ~80ms on an iPhone 4
const NSUInteger kPBKDFRounds3 = 10;
...
+ (NSData *)AESPass:(NSString *)password {
    ...
    NSData *salt = [NSData dataWithBytes:saltBuff1
